      ...
      <section class="software section section--page" aria-label="Software projects">
        ...
        <div class="software-projects">
          <article class="software-card">
            ...
            <p>A local, browser-based atlas that maps images from an AstroBin account or library onto Aladin Lite. Version 1.2.0-beta.6 opens with a north-up, 360° Hammer–Aitoff overview, draws projection-safe image footprints, and can optionally replace approximate AstroBin geometry with locally solved ASTAP footprints.</p>
            <ul><li>North-up whole-sky Hammer–Aitoff view</li><li>Projection-safe footprints and image previews</li><li>Optional local ASTAP solving and caching</li></ul>
            <div class="software-guide">
              <section aria-labelledby="sky-mapper-use"><h4 id="sky-mapper-use">How to use it</h4><p>Navigate or zoom the Aladin Lite sky and select a footprint to inspect its image and metadata. Choose outline or image-overlay mode, set the page size to control how many AstroBin images are drawn, and use Home to restore the north-up 360° × 180° Aitoff overview. Images without usable coordinates are omitted from the map and reported in the server log.</p></section>
              <section aria-labelledby="sky-mapper-install"><h4 id="sky-mapper-install">Install beta.6 on Windows</h4><ol><li>Install Node.js 22.13 or newer and use a current WebGL-capable browser.</li><li>Download the beta.6 ZIP below and extract it to a writable folder.</li><li>Run <code>Start-AstroBinSky.bat</code>. On first launch, add your AstroBin username, API key, and secret to the local <code>config.json</code>.</li><li>Save the file and return to the launcher. The atlas opens locally at <code>127.0.0.1:8787</code>.</li></ol></section>
            </div>
            <div class="software-notes" aria-label="AstroBin Sky Mapper documentation notes">
